...
var Main = {
    ...
    initSwiper: function () {
        var slide_container_quotation = new Swiper('#slide_container_quotation', {
        ...
        $(".quotation_play_control").on("click", function () {
        ...
        $(".switch_left").on("click", function () {
            ...
            slide_container_quotation.slidePrev();
        ...
        $(".switch_right").unbind("click").bind("click", function () {
            ...
            slide_container_quotation.slideNext();
        });
    },
};
$(function () {
